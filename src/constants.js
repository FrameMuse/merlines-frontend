...
const monthNamesDate = { 1: 'Января', 2: 'Февраля', 3: 'Марта', 4: 'Апреля', 5: 'Мая', 6: 'Июня', 7: 'Июля', 8: 'Августа', 9: 'Сентября', 10: 'Октября', 11: 'Ноября', 12: 'Декабря' };
const monthsShortNamesByNumbers = { 1: 'Янв', 2: 'Фев', 3: 'Мар', 4: 'Апр', 5: 'Мая', 6: 'Июн', 7: 'Июл', 8: 'Авг', 9: 'Сен', 10: 'Окт', 11: 'Ноя', 12: 'Дек' };
const weekDaysByNumbers = { 1:'Пн', 2:'Вт', 3:'Ср', 4:'Чт', 5:'Пт', 6:'Сб', 7:'Вс' };
const Transport = {
  air: {
    name: 'Самолёты',
    path: 'air'
...
const accessPopupFieldsData = {
  login: {
    title: 'Войти',
    data: [
      { id: 'email', type: 'email', name: 'e-mail', inputName: 'email', class: '' },
      { id: 'password', type: 'password', name: 'пароль', inputName: 'password', class: 'modal__form-group--last' },
    ]
  }
  ,
  registration: {
    title: 'Регистрация',
    data: [
      { id: 'name', type: 'text', name: 'имя', inputName: 'username', class: '' },
      // { id: 'surname', type: 'text', name: 'фамилия', inputName: '', class: '' },
      { id: 'email', type: 'email', name: 'e-mail', inputName: 'email', class: '' },
      { id: 'password', type: 'password', name: 'пароль', inputName: 'password', class: '' },
