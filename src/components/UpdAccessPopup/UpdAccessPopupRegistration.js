...
function UpdAccessPopupRegistration({ userData, takeUserData, setPopupName, setUserData }) {
        ...
        <div className="modal__bottom">
          <div className="checkbox checkbox--modal">
            ...
            <label className="checkbox-label" htmlFor="check">
              <Svg svgClass="checkbox-icon" svgName="checkbox" svgWidth="13" svgHeight="13" />
            Запомнить меня
          </label>
          </div>
        </div>
        <input onClick={onSubmitRegisterForm} className="modal__submit" type="submit" value="Зарегистрироваться" />
      </form>
