  ...
  return (
    <>
      <div className="cabinet__col-wrap cabinet__col-wrap--subscription">
        ...
        <LkSwitcher setIsActiveRoutes={setIsActiveRoutes} setIsActiveTickets={setIsActiveTickets} />
      </div>
      <div className="cabinet__empty cabinet__empty--subscription">
        {isActiveRoutes && <h3 className="cabinet__empty-text">В данном разделе пока пусто</h3>}
        {isActiveTickets && <h3 className="cabinet__empty-text">В данном разделе пока пусто</h3>}
      </div>
    </>
  )
};
