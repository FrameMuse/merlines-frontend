...
function LkSwitcher({ setIsActiveRoutes, setIsActiveTickets, subscribes }) {
  ...
  const routesClass = `subnav-link ${
    favouritesMenu.isActiveRoutes ? "subnav-link--active" : ""
  }`
  const ticketsClass = `subnav-link ${
    favouritesMenu.isActiveTickets ? "subnav-link--active" : ""
  }`
