...
function PriceCalendarDaysFilter() {
  ...
  return (
    <div className={`filter filter--${filterActive ? "opened" : "closed"}`}>
      <Svg handleClick={openFilter} svgClass="days__filter" svgName="filter" svgWidth="15" svgHeight="15" />
      <div className="filter__inner" >
        ...
        <ul className="filter__list">
          <li className="filter__item">
            <button className="filter__item-btn" type="button">Пересадки</button>
          </li>
        </ul>
      </div>
    </div>
