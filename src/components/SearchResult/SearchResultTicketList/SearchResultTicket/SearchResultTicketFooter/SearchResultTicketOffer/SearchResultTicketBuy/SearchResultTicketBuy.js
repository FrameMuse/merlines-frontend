...
import { selectSearchResult, setIsOpenRedirect, setTicketDilerName } from '../../../../../../../reducers/searchResultSlice';
...
function SearchResultTicketBuy({ link, ticketDealerName }) {
  ...
  return (
    <button onClick={getLink} className="btn btn--sm" type="button">Выбрать</button>
  )
};
