...
function SearchResultTicketOffer({ price, description, ticketDealerName, ticketDealerLogo, link }) {
    ...
    <div className="ticket__content-top">
      <div className="ticket__content-row">
        <div className="ticket__content-left">
          <div className="ticket__content-price">{separateThousand(price)} &nbsp;₽</div>
        ...
        <div className="ticket__content-right">
          <SearchResultTicketBuy link={link} ticketDealerName={ticketDealerName} />
        </div>
      </div>
    </div>
  )
