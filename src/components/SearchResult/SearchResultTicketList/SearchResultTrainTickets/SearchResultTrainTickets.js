...
const SearchResultTrainTickets = () => {
  ...
  return (
    <>
      <div className="ticket-list__not-found" style={{paddingBottom: "125px", justifyContent: "end"}}>
        <h2 style={{width: "100%"}} className="ticket-list__title">Поиск билетов на поезда еще в разработке</h2>
        <p style={{width: "100%"}} className="ticket-list__error-head">Мы работаем работаем над этим</p>
      </div>
