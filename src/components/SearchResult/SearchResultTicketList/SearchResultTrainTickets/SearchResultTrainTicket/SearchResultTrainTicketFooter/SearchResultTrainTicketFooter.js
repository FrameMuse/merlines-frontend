...
const SearchResultTrainTicketFooter = ({voyages, sellers, transfers, flightDuration, setIsOpenMoreInfo, isOpenMoreInfo}) => {
    ...
    <>
      <div className="ticket__footer">
        <div className="ticket__trine-menu">
          <button className="ticket__trine-btn ticket__trine-btn--active" type="button">Плацкарт
            <Svg svgClass="btn__arrow-icon" svgName="arrow-open" svgWidth="8" svgHeight="8" />
          </button>
        </div>
