...
function SearchResultTicketList({
  ...
  const [searchResultBusListPagination, setSearchResultBusListPagination] =
    useState([])
  ...
  return (
    <>
      ...
      <aside className="ticket-list__left">
        ...
        {tickets && searchTransportIs === transport.air && (
          <SearchResultFilters checkboxes={returnInputs(tickets, transfers)} />
        )}
      </aside>
