...
import SearchResultBusFiltersContainer from "./SearchResultTrainFiltersContainer"

function SearchResultTrainContainer() {
    ...
    <SearchResultTickets>
      ...
      <div className="ticket-list__content">
        ...
        <div className="ticket-list__error">
          <h2 className="ticket-list__title">Поиск билетов на поезда ещё в разработке</h2>
...
export default SearchResultTrainContainer