...
import { selectFilter, setDurationMin, setDurationMax } from '../../../reducers/filtersSlice';
...
function SearchResultCustomFilterDuration() {
  ...
  return (
    <li className={`filters__item ${isTransferOpen ? "filters__item--opened" : ""}`}>
      <button onClick={openTransfer} className="filters__btn" type="button">Время в пути</button>
