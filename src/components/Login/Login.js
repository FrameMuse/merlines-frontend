      ...
      <>
        ...
        <form className='modal__form' onSubmit={this.onSubmitLoginForm}>
          <div className='input-group modal__form-group'>
            ...
            />
            {
              !this.state.emailValidity
                ?
                <label className='input-group__label input-group__label--error' htmlFor='login_email'>
                  {this.state.emailValidationMessage}
                </label>
                :
                <label className='input-group__label' htmlFor='login_email'>Email</label>
            }
          </div>
          <div className='input-group modal__form-group modal__form-group--last'>
            ...
            />
            {
              !this.state.passwordValidity
                ?
                <label className='input-group__label input-group__label--error' htmlFor='login_password'>
                  {this.state.passwordValidationMessage}
                </label>
                :
                <label className='input-group__label' htmlFor='login_password'>Пароль</label>
            }
          ...
          <div className="modal__bottom">
            ...
            <Link className="modal__link-recovery" to={routes.resetPassword}>Забыли пароль?</Link>
          </div>
