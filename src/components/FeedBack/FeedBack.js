      ...
      <section className="feedback">
        ...
        <div className="feedback__wrap">
          <form className="feedback__form" action="#">
            ...
            <textarea
              className="textarea feedback__textarea"
              placeholder="Введите текст..."
            ></textarea>

            <input
              className="btn feedback__submit"
              type="submit"
          ...
          <div className="contacts">
            <div className="contacts__item">
              ...
              <Link className="contacts__info" to="tel:+74012722398">
                +7 4012-72-23-98
              </Link>
            </div>
            ...
            <div className="contacts__item">
              ...
              <Link
                className="contacts__item-link contacts__item-link--instagram"
                to="#"
              >
              ...
              <Link
                className="contacts__item-link contacts__item-link--facebook"
                href="#"
              >
                <svg className="contacts__item-icon" width="15" height="15">
