    ...
    <section className="transfer overlay">
      <div className="transfer__container">
        <div className="transfer__content">
          <Svg svgClass="transfer__loading" svgName="loading" svgWidth="32" svgHeight="32" />
          <p className="transfer__text">Немного терпения, переходим на сайт <Link className="transfer__link" to="#">{searchResultData.ticketDilerName}</Link></p>
