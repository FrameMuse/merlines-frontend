...
const InputDepartureDate = ({dateFromInputRef, dateToInputRef}) => {
  ...
  useEffect(() => {
    const handleOverlayClose = evt => {
      const eventTargetClosest = !!evt.target.closest('.form__group.form__group--date-dep')
      const isCalendarDisplayed = !!!document.querySelector('.drop-down-calendar.block-hidden')
  ...
  return (
    <div className="form__group form__group--date-dep">
      ...
      <label className="form__label" htmlFor="date-departure">туда</label>
