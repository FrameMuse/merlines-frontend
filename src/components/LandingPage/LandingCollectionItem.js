  ...
  return (
    <li className="section__item">
      <div className="article-card article-card--index">
        ...
        <Link className="article-card__tag" to="#">{tag}</Link>
        <Link className="article-card__title" to="#">{title}</Link>
        <time className="article-card__date" dateTime={ISODate}>{fromISOtoString(ISODate)}</time>
      </div>
    </li>
  )
};
