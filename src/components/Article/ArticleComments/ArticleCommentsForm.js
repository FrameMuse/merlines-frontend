    ...
    <form className="comments__form">
      <header className="comments__form-header">
        ...
        <span className="comments__info comments__info--closed">
          ответ для <Link className="comments__info-link" to="#">Григорий Пронин</Link>
        </span>
        <div className="comments__form-info">
          (<span className="comments__symbol-counter">0</span>/500 символов)
        </div>
      </header>
      <textarea className="comments__message" placeholder="Введите текст комментария..."></textarea>
