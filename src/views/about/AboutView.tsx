      ...
      <div className="about__container">
        <div className="about__intro">
          <div className="about__intro-content">
            ...
            <p className="text">«ТТК Merlines» – это современная <span className="nowrap">транспортно-туристическая</span>
              компания с имиджем технологичной, прогрессивной, современной <span className="nowrap">IT-компании</span>.
            </p>
          </div>
        </div>
        <section className="about__improvement">
          ...
          <ul className="about__improvement-list">
            <li className="about__improvement-item about__improvement-item--mask"><span className="about__improvement-number">1.</span>
              <div className="about__improvement-box"><span className="about__improvement-caption">6 350 000 людей</span>
                <p className="about__improvement-text">Отправили в незабываемую поездку</p>
              </div>
            </li>
            <li className="about__improvement-item"><span className="about__improvement-number">2.</span>
            ...
            <li className="about__improvement-item"><span className="about__improvement-number">3.</span>
              <div className="about__improvement-box">
        ...
        <section className="about__mission">
          <h2 className="h2 about__mission-title">Наша миссия -<br />открыть вам весь мир.</h2>
          <p className="text about__mission-text">Это то, что заставляет нас делать всё возможное для расширения
            ...
            положительное влияние на сообщества, в которых мы живем и работаем.</p>
